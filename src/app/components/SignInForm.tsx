...
const SignInForm: React.FC<SignInFormProps> = ({ auth, onSignInSuccess }) => {
    ...
    return (
        <div className="relative flex justify-center items-center h-screen">
            <div className="absolute bg-cover bg-center inset-0" style={{ backgroundImage: "url('assets/chat.jpg')" }}></div>
            <div className="z-10 max-w-sm p-6 bg-white text-gray-900 rounded shadow-md bg-opacity-50">
                <input
